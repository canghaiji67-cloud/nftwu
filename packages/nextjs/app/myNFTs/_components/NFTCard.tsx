...
const sanitizeImageUrl = (url?: string) => {
  ...
  // 修复之前错误的专用网关地址
  if (url.includes("green-payable-guan-79.mypinata.cloud")) {
    return url.replace("green-payable-guan-79.mypinata.cloud", "gateway.pinata.cloud");
  }
  return url;
};
  ...
  return (
    <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 border border-base-300 overflow-hidden group relative">
      ...
      <figure className="relative overflow-hidden">
        ...
        <img 
          src={sanitizeImageUrl(nft.image)} 
          alt="NFT Image" 
